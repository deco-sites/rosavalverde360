...
export interface SDK {
  CART: {
    ...
    addToCart: (items: Item[], platformProps: unknown) => boolean;
    subscribe: (
  ...
  return (
    <>
      ...
      <Drawer
        ...
        aside={
          <Drawer.Aside title="minhas escolhas" drawer={MINICART_DRAWER_ID}>
            <div
              class="border-t-[#E7D8D8] h-full flex flex-col bg-[#FDF0F0] items-center justify-center overflow-auto"
              style={{
