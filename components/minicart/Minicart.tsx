          ...
          {count === 0
            ? (
              <div class="flex flex-col gap-6">
                ...
                <label
                  ...
                  class="btn border-[#797979] hover:border-[#797979] !text-black btn-outline rounded-none no-animation"
                >
                  Escolher produtos
                </label>
              </div>
            ...
            : (
              <>
                ...
                <footer class="w-full">
                  {/* Subtotal */}
                  <div class="border-none py-2 flex flex-col">
                    {discounts > 0 && (
                    ...
                    <div class="w-full flex justify-between px-4 text-sm text-[#1E1E1E] pb-3 border-b border-[#E7D8D8] ">
                      <span>Subtotal</span>
                      <output class="font-bold" form={MINICART_FORM_ID}>
                        {formatPrice(subtotal, currency, locale)}
                      </output>
                    </div>
                    <p class="p-4 text-center text-base font-light">
                      adicione "vale trocas" ou "cartão presente" no fechamento
                      da compra
                    </p>
                    <div hidden>
                      {enableCoupon
                        ? <Coupon coupon={coupon} />
                        : "adicione “vale trocas” ou “cartão presente” no fechamento da compra"}
                    </div>
                  </div>
                  ...
                  <div class="p-4 flex flex-col gap-2">
                    <a
                      class="btn rounded-none bg-[#423D3F] hover:bg-[#423D3F] w-full no-animation"
                      href={checkoutHref}
                      hx-on:click={useScript(sendBeginCheckoutEvent)}
                    >
                      <span class="[.htmx-request_&]:hidden text-white font-light">
                        finalizar compra
                      </span>
                    ...
                    <label
                      for={MINICART_DRAWER_ID}
                      class="btn border-[#797979] hover:border-[#797979] !text-black font-light btn-outline bg-transparent hover:bg-transparent rounded-none no-animation"
                    >
                      continuar comprando
                    </label>
                  </div>
