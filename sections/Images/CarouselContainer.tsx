  ...
  return (
    <div
      ...
      class={clx(
        ...
        "w-screen container px-5 pt-0",
      )}
    >
      <div class="col-span-full row-span-full">
        <Slider class="carousel carousel-center w-full md:justify-center space-x-4 h-full">
          {images.map((image, index) => (
            <Slider.Item
              index={index}
              class="carousel-item w-full md:w-1/3"
      ...
      <div class="flex items-center md:hidden justify-center z-10 col-start-3 row-start-2">
        <Slider.NextButton
          class="btn btn-neutral border-0 btn-outline btn-circle no-animation btn-sm"
          disabled={false}
        >
